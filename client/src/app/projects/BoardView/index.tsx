  ...
  return (
    ...
    >
      <div className="mb-3 flex w-full">
        <div
          className={`w-3 !bg-[${statusColor[status]}] rounded-s-lg`}
          style={{ backgroundColor: `${statusColor[status]}` }}
        />
        <div className="rouned-e-lg flex w-full items-center justify-between bg-white px-5 py-4 dark:bg-dark-secondary">
